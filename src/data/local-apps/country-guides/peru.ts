...
export const LOCAL_APP_GUIDE: RawLocalAppGuideDefinition = {
  "slug": "peru",
  "teaser": {
    "zh-CN": "秘鲁更适合先把打车、外卖、购物和住宿入口准备好，落地后的动作会顺很多。",
    "en-US": "Peru works best when rides, delivery, shopping, and stays are sorted before you land."
  },
  "intro": {
    "zh-CN": "秘鲁更适合围绕打车、地图、购物、探店、外卖和住宿来搭 app 栈。先把这些层准备好，机场进城、找饭吃和临时补货都会顺很多。",
    "en-US": "Peru works best when the app stack is built around rides, maps, shopping, food discovery, delivery, and stays. Getting those layers ready early makes airport arrivals, meals, and replacement shopping much smoother."
  },
  "highlights": {
    "zh-CN": [
      "打车",
