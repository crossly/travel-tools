...
const messages: Messages = {
  'zh-CN': {
    ...
    'settings.deviceIdentity': '设备身份',
    'settings.deviceIdentityDescription': '系统会自动为旅行 AA 生成一个易读身份名。',
    'settings.deviceIdentityNote': '这个身份名用于标识这台设备创建的行程和支出。',
    'settings.deviceIdentityMissing': '这台设备还没有旅行 AA 身份。',
    'settings.openSplitBill': '打开旅行 AA',
    ...
    'home.identityStepTitle': '这台设备的身份',
    'home.identityStepDescription': '系统会自动生成一个 emoji + 名词 的身份名，用于标识创建者。',
    ...
    'home.identityReadyHint': '无需手动设置，创建行程时会自动使用这个身份。',
  ...
  'en-US': {
    ...
    'settings.deviceIdentityDescription': 'Split Bill generates a readable identity for this device automatically.',
    'settings.deviceIdentityNote': 'This identity is used to label trips and expenses created from this device.',
    'settings.deviceIdentityMissing': 'This device does not have a Split Bill identity yet.',
    'settings.openSplitBill': 'Open Split Bill',
    ...
    'home.identityStepTitle': 'This device identity',
    'home.identityStepDescription': 'A playful emoji + noun name is generated automatically to label the creator.',
    ...
    'home.identityReadyHint': 'No setup needed. New trips will use this identity automatically.',
