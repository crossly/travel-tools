...
const messages: Messages = {
  'zh-CN': {
    ...
    'home.identityStepDescription': '昵称会用于创建行程和记录支出。',
    ...
    'home.createTripLocked': '先保存设备昵称，再创建行程。',
    ...
    'error.MISSING_DEVICE_ID': '缺少设备身份，请重新保存昵称',
  ...
  'en-US': {
    ...
    'home.identityStepDescription': 'Your nickname is used for trips and expenses.',
    ...
    'home.tapToEditNickname': 'Tap the nickname to edit it',
    ...
    'home.createTripLocked': 'Save your nickname before creating a trip.',
    ...
    'error.MISSING_DEVICE_PROFILE': 'Set your device nickname first',
    'error.MISSING_DEVICE_ID': 'Missing device identity. Save the nickname again.',
