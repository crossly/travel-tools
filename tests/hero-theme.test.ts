...
vi.mock('@/lib/i18n', () => ({
  ...
  useI18n: () => ({
    t: (key: string, values?: Record<string, string | number>) => ({
      ...
      'site.homeDescription': 'One shell, one design system, and a compact set of travel tools for money, phrases, local apps, visa checks, tipping, packing, timing, and trip recovery.',
      ...
      'site.companionToolsTitle': 'Add language, entry checks, tipping, local app setup, and recovery support around the trip',
      'site.companionToolsDescription': 'Travel phrases help in person, visa entry cards help before landing, tipping rules help before payment, local app guides tell you what to install before departure, and jet lag plans help after arrival.',
      ...
      'site.visaEntryPreview': 'Quick entry checks for arrival cards, declarations, and official links',
      'site.visaEntryMetric': 'Entry basics',
      'site.tippingPreview': 'Quick tipping notes for meals, taxis, stays, and local service habits',
      'site.tippingMetric': 'Tipping basics',
