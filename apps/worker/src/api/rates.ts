...
import { supportedCurrencies } from '@travel-tools/shared/currencies';
import { buildRatesResult, RATES_TTL, type FrankfurterResponse, type RatesResult } from '@travel-tools/shared/fx';
